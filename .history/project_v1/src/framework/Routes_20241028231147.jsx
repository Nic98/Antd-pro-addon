...
import RegisterForm from '../page/login/Register.jsx';
import DynamicComponentLoader from '../page/loader/index.jsx';
...
routes.childRoutes.push(
  ...
  { path: '*', component: Error404 },
    {path:'/', component:{component:DynamicComponentLoader,loadComponent:()=>import('../page/login/Login.jsx')}}
);
