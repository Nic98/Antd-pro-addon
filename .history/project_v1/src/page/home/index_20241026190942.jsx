            ...
            <Layout>
              <Sider width={200} style={{ background: '#fff' }}>
                ...
                >
                  ...
                  <SubMenu key={'sub7'} title={<span><Icon type="area-chart" />{'页面控制'}</span>}>
                    <Menu.Item key="sub7-1" onClick={() => { this.bindCurrentKey('/pageControl') }}>页面控制</Menu.Item> 
                  </SubMenu>

                  <SubMenu key="sub6" title={<span><Icon type="shopping-cart" />{'低代码'}</span>}>
                    <Menu.Item key="sub6-1" onClick={() => { this.bindCurrentKey('/lowcode') }}>低代码preview</Menu.Item>
                  </SubMenu>
                </Menu>
              </Sider>
