...
},
{
  ...
  render: (text, record) => (
    <span>
      <a href="javascript:;" onClick={() => { deleteGoods(record); }}>删除</a>
...
export default function Warehouse() {
  ...
  const memoizedFilterParamList = useMemo(() => filterparamList, [filterparamList]);

  useEffect(() => {
    console.log('useEffect called with memoizedFilterParamList:', memoizedFilterParamList);
    getGoodsList()
      .then(res => {
        console.log(res);
