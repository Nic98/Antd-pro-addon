...
import type { FieldOption, ComponentInstance, GetUseFieldOption, FieldMeta, RerenderFunction, WatchCallback, NormalizedFieldOption, InitOption, FieldValues, NormalizedFieldMeta, Rule, FieldState, ValidateCallback, ValidateErrorGroup, RerenderType, WatchTriggerType, ValidatePromiseResults, InitResult } from './types';
declare class Field {
    ...
    init<ValueType = any, OtherProps extends object = object>(name: string, option?: InitOption<ValueType, never, never, OtherProps>, rprops?: OtherProps): Omit<OtherProps, keyof InitResult<'value', 'onChange', ValueType>> & InitResult<'value', 'onChange', ValueType>;
    init<ValueType = any, ValueName extends string = 'value', Trigger extends string = 'onChange', OtherProps extends object = object>(name: string, option?: InitOption<ValueType, ValueName, Trigger, OtherProps>, rprops?: OtherProps): Omit<OtherProps, keyof InitResult<ValueName, Trigger, ValueType>> & InitResult<ValueName, Trigger, ValueType>;
    /**
     * 获取单个输入控件的值
     * @param name - 字段名
     * @returns 字段值
    ...
    _validate(name: string, rule: Omit<Rule, 'trigger'>[], trigger: string): void;
    /**
     * splice array
     */
